...
//!
//! These tests validate that CLI request/response types serialize correctly.
//! Uses static schema definitions to ensure CLI types match API expectations.
...
mod request_validation {
    ...
    fn test_save_request_serializes_correctly() {
        ...
        // Verify optional fields serialize when present
    ...
    fn test_confirm_request_serializes_correctly() {
        ...
        // Verify archive_digest is NOT present (removed)
