...
Keep this file short. It is loaded often; durable detail belongs in skills and `.comprehension`.
...
- For broad CLI behavior or ownership questions, start at `.comprehension/README.md`.
- For implementation rules, read `.comprehension/agent-working-contract.md`.
