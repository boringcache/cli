...
If you are wiring GitHub Actions, use [`boringcache/one@78e1fd3257bbdf27722c46b500a39b6626fc8d27`](https://github.com/boringcache/one) after onboard so CI can reuse the same repo config and trust model.
