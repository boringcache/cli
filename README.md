...
If you are wiring GitHub Actions, use [`boringcache/one@b372edd91cda127cb03c64967df35c3836d47f2a`](https://github.com/boringcache/one) after onboard so CI can reuse the same repo config and trust model.
