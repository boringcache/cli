...
If you are wiring GitHub Actions, use [`boringcache/one@b1d1e466317cde2d78a86f8cb94347deebb501e9`](https://github.com/boringcache/one) after onboard so CI can reuse the same repo config and trust model.
