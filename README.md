...
If you are wiring GitHub Actions, use [`boringcache/one@8294be671cd5a2b73638df1b8e1e240df888297e`](https://github.com/boringcache/one) after onboard so CI can reuse the same repo config and trust model.
