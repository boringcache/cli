...
If you are wiring GitHub Actions, use [`boringcache/one@6b7033721b37075b2138fd0c769bf088e0836ce6`](https://github.com/boringcache/one) after onboard so CI can reuse the same repo config and trust model.
