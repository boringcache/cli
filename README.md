...
If you are wiring GitHub Actions, use [`boringcache/one@e24257b122813ad11d53b9ed024b474ca4946ad2`](https://github.com/boringcache/one) after onboard so CI can reuse the same repo config and trust model.
