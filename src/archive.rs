...
fn write_archive(
    ...
    // Always include checksum for archive integrity verification
...
fn select_compression_level(total_size: u64, resources: &SystemResources) -> i32 {
    // Zstd level 3 is the default and provides good speed/compression balance
    // Levels 3-6 are fast with multithreading and give much better ratios than 0-2
...
/// Encrypt an archive file using age encryption
...
/// Decrypt an archive file using age encryption
