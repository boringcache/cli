...
pub struct AdapterConfig {
    ...
    pub legacy_cache_ref_tag: Option<String>,
    #[serde(
        rename = "cache-run-ref-tag",
        alias = "cache_run_ref_tag",
        skip_serializing_if = "Option::is_none"
    )]
    pub legacy_cache_run_ref_tag: Option<String>,
    #[serde(
        default,
    ...
    pub legacy_cache_from_ref_tags: Vec<String>,
    #[serde(
        default,
    ...
    pub legacy_cache_promote_ref_tags: Vec<String>,
    #[serde(
