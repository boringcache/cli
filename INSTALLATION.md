...
- **Linux**: AMD64, ARM64
- **macOS**: Apple Silicon and Intel through universal binaries
...
- `libboringcache_xcode_cas-macos-universal.dylib`
...
The script installs the CLI to the first writable location. On macOS it also
