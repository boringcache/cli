...
This document describes how to set up the `curl -sSL https://install.boringcache.com/install.sh | sh` installation method for the BoringCache CLI.
...
### Test the script URL:
```bash
curl -sSL https://install.boringcache.com/install.sh
```
