...
3. For CLI/cache/proxy/release work, use `/Users/gaurav/.codex/skills/cli-expert/SKILL.md` as a Codex-facing pointer to the same CLI rules.
4. Update the relevant `/Users/gaurav/boringcache/web/.planning/features/cli-*.md` file before handoff when command surface, flags, env/config behavior, cache lifecycle, proxy/adapters, release workflows, module ownership, support reachability, or file coverage changes.
