...
- action/proxy metadata transport now preserves `ci_run_started_at` or another Rails ordering field through first-class CLI proxy save request fields; capped metadata hints remain replay/debug labels and compatibility fallback;
