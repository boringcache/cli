...
- `e2e-oci-rooted-restore-isolation-test.sh` covers old rooted alias compatibility; new CLI Docker/BuildKit paths use resolved human tags directly for normal registry-cache refs.
