...
- `ci_detection` is active through save/mount/CAS publish request metadata, telemetry tagging, and Docker run-ref planning; it owns provider-neutral `BORINGCACHE_CI_*` run metadata plus GitHub Actions mapping
